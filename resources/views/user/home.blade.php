                ...
                <div class="maghny-gd-1 col-lg-6">
                    <div class="maghny-grid">
                        ...
                        <div class="room-info">
                            ...
                            <a href="{{route('book')}}" class="btn btn-style btn-primary mt-sm-4 mt-3">Book Now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 left-wthree-img text-righ">
                        <div class="position-relative">
                            <img src="user/images/videobg.jpg" alt="" class="img-fluid" />
                    ...
                    <div class="col-lg-6 mt-lg-0 mt-5 about-right-faq align-self">
                        ...
                        <a href="{{route('about')}}" class="btn btn-style btn-primary mt-4">Check all packages</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="quotation py-5">
        <div class="container py-xl-5 py-lg-3">
            <div class="welcome-left text-center py-md-5 py-3">
                ...
                <a href="{{route('book')}}" class="btn btn-style transparent-btn mt-sm-5 mt-4 mr-2">Book Now</a>
