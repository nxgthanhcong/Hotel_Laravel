        ...
        <div class="maghny-gd-1">
            ...
            <div class="row mt-5">
                <div class="maghny-gd-1 col-lg-4 col-md-6">
                    <div class="maghny-grid">
                        <figure class="effect-lily border-radius">
                            <img class="img-fluid" src="user/images/about1.jpg">
                ...
                <div class="maghny-gd-1 col-lg-4 col-md-6 mt-md-0 mt-4">
                    <div class="maghny-grid">
                        <figure class="effect-lily border-radius">
                            <img class="img-fluid" src="user/images/about2.jpg">
                            <figcaption class="w3set-hny">
                                <div>
                ...
                <div class="maghny-gd-1 col-lg-4 col-md-6 mt-lg-0 mt-4">
                    <div class="maghny-grid">
                        <figure class="effect-lily border-radius">
                            <img class="img-fluid" src="user/images/about3.jpg">
                            <figcaption class="w3set-hny">
                                <div>
		...
		<div class="row inner-sec-w3layouts-w3pvt-lauinfo">
			<div class="col-md-3 col-6">
				<div class="team-grids text-center">
					<img src="user/images/team1.jpg" class="img-fluid" alt="">
					<div class="team-info">
						<div class="caption">
							<h4>John Doe</h4>
			...
			<div class="col-md-3 col-6">
				<div class="team-grids text-center">
					<img src="user/images/team2.jpg" class="img-fluid" alt="">
					<div class="team-info">
						<div class="caption">
							<h4>Alexander</h4>
			...
			<div class="col-md-3 col-6 mt-md-0 mt-4">
				<div class="team-grids text-center">
					<img src="user/images/team3.jpg" class="img-fluid" alt="">
					<div class="team-info">
						<div class="caption">
							<h4>Martin ker </h4>
							<h6>Chairmen</h6>
			...
			<div class="col-md-3 col-6 mt-md-0 mt-4">
				<div class="team-grids text-center">
					<img src="user/images/team4.jpg" class="img-fluid" alt="">
					<div class="team-info">
						<div class="caption">
							<h4>Elizabeth </h4>
							<h6>Manager</h6>
                ...
                <div class="col-lg-10 mx-auto">
                    <div class="owl-testimonial owl-carousel owl-theme">
                        <div class="item">
                            <div class="slider-info mt-lg-4 mt-3">
                                <div class="img-circle">
                                    <img src="user/images/team1.jpg" class="img-fluid rounded" alt="client image">
                                </div>
                        ...
                        <div class="item">
                            <div class="slider-info mt-lg-4 mt-3">
                                <div class="img-circle">
                                    <img src="user/images/team2.jpg" class="img-fluid rounded" alt="client image">
                                </div>
                                <div class="message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit id
                                    accusantium
                                    officia quod quasi necessitatibus perspiciatis Harum error provident
                        ...
                        <div class="item">
                            <div class="slider-info mt-lg-4 mt-3">
                                <div class="img-circle">
                                    <img src="user/images/team3.jpg" class="img-fluid rounded" alt="client image">
                                </div>
                                <div class="message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit id
                                    accusantium
                                    officia quod quasi necessitatibus perspiciatis Harum error provident
                        ...
                        <div class="item">
                            <div class="slider-info mt-lg-4 mt-3">
                                <div class="img-circle">
                                    <img src="user/images/team4.jpg" class="img-fluid rounded" alt="client image">
                                </div>
                                <div class="message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit id
                                    accusantium
                                    officia quod quasi necessitatibus perspiciatis Harum error provident
